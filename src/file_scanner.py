...
def scan_video_files(directory):
    ...
    try:
        for root, dirs, files in os.walk(abs_directory):
            ...
            # Break early if we've found enough for testing (optional limit)
            # if video_files_found >= 50:  # Limit for testing purposes
            #     log.info(f"[SCAN] Limiting scan to first 50 videos for testing")
            #     break
...
def get_catalog_summary():
    """
    Returns a summary of the current catalog for debugging.
    """
